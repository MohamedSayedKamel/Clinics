...
@Service("antiplateletAgentBeanConverter")
public class AntiplateletAgentBeanConverter implements Converter<VisitDetailsResponse, AntiplateletAgentBean> {

	@Override
	public AntiplateletAgentBean convert(VisitDetailsResponse source) throws ConversionException {
		if(source ==null)
		{
			throw new ConversionException("source must not be null!");
		}
		
		AntiplateletAgentBean target =new AntiplateletAgentBean();
		target.setStrAntiplateletAgent(source.getStrAntiplateletAgent());
		target.setAntiplateletAgentDrugs(source.getAntiplateletAgentDrugs());
	...
	@Override
	public AntiplateletAgentBean convert(VisitDetailsResponse source, AntiplateletAgentBean target)
